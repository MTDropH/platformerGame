...
player_img = pygame.transform.scale(pygame.image.load("Jack/Max final run 1.png").convert_alpha(), (TILE, int(TILE * 1.5)))
enemy_img = pygame.transform.scale(pygame.image.load("Jack/Max final run 1.png").convert_alpha(), (TILE, TILE))
platform_img = pygame.transform.scale(pygame.image.load("Jack/Max final run 1.png").convert_alpha(), (TILE, TILE))
flag_img = pygame.transform.scale(pygame.image.load("Jack/Max final run 1.png").convert_alpha(), (TILE, 2 * TILE))


# --- Entity Classes ---
class Entity(pygame.sprite.Sprite):
    def __init__(self, x, y, w, h, image=None, colour=None):
        super().__init__()
        if image:
            self.image = image
        else:
...
class Player(Entity):
    def __init__(self, x, y):
        super().__init__(x, y, TILE, int(TILE * 1.5), image=player_img)
...
class Enemy(Entity):
    def __init__(self, x, y, left_bound, right_bound):
        super().__init__(x, y, TILE, TILE, image=enemy_img)
